...
<div class="navbar navbar-inverse navbar-fixed-top">
  <div class="navbar-inner">
    <div class="container">
      ...
      </a> <a class="brand" href="/..">Moviecatalog</a>
...
<!-- add movieId UserId and ratings here -->

  <form class="movie-input-form form-inline" action="moviefun"
        method="post">
    <p>Add Movie Ratings</p>
    <%--
    <input type="text" name="title" placeholder="Title" size="29"/>
    <input type="text" name="director" placeholder="Director" size="17"/>
    <input type="text" name="genre" placeholder="Genre" size="14"/>
    <input type="text" name="rating" placeholder="Rating" size="7"/>
    <input type="text" name="year" placeholder="Year" size="4" style="width: 110px;"/>
     --%>
     <input type="text" name="userId" placeholder="UserID" size="12"/>
     <input type="text" name="movieId" placeholder="MovieID" size="12"/>
     <input type="text" name="userRating" placeholder="Rating" size="10"/>
    ...
    <c:forEach items="${movies}" var="movie">
      <tr>
        ...
        <td><c:out value="${movie.description}"/></td>
         <td><a target="_blank" rel="noopener noreferrer" href="https://www.themoviedb.org/movie/${movie.movieId}"> more details </a></td>
        <td><a href="?action=Remove&id=${movie.movieId}"><i
